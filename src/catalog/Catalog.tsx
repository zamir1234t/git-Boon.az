        ...
        <div className="bac">
          ...
          <div className="catalog-wrapper d-flex">
            ...
            <div className="catalog-menu">
              <div className="catalog-title"><i className="fa-solid fa-cubes-stacked"></i> Каталог</div>
            ...
            <div className="icons">
              <div className="right">
               ...
               <i className="fa-regular fa-heart"></i>
                ...
                <Link to='/store'><i className="fa-duotone fa-solid fa-cart-plus"></i></Link>
              </div>
            </div>
          </div>

          <div className="content-overlay">
            <h1 className="main-title text-center" style={{fontSize: '30px'}}>Подарки для женщин купить в Баку</h1>
            <br />
            ...
            <br />
            <h2 className="section-title text-center" style={{fontSize: '30px'}}>Идеи для женских подарков</h2>
            <br />
            ...
            <br />
            <p className="description">
            Каким бы ни был повод, с нами вы подберете удачный подарок женщине и сможете сделать праздник незабываемым. Доставьте удовольствие и ей и себе, отдавая предпочтения чему-то необычному, оригинальному и удивительному.
            </p>
          </div>
        </div>
      </main>
