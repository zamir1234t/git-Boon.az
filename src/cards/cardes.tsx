...
function Cardes() {
  ...
  const cards = [
    ...
    },
    {
      ...
      img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgEKyHTxFYqhPVZbtjfQDU9OoSFo8pnMiedA&s',
      text: 'есть в наличии',
      AZN: '97.60',
      discount: '122.00',
      azn: '24.40'
    ...
    },
    {
      ...
      img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6QoAxIfdpcJnRMm90y1ERodvb-dyh9I37wQ&s',
      text: 'есть в наличии',
      AZN: '5.92',
      discount: '7.40',
      azn: '1.48'
  ...
  const filterDataAndCards = [...cards, ...data];
  const displayCards = searchTerm ? filterDataAndCards : cards;
